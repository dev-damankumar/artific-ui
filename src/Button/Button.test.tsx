...
describe('Render Button Layouts', () => {
    ...
    layouts.forEach(layout => {
        test(`render ${layout} layout`, () => {
            const {container} = render(
                <Button layout={layout}>Click Me</Button>,
            )
            const component = container.firstChild
            expect(component).toHaveClass(
...
describe('Render Button States', () => {
    ...
    test('render loading button', () => {
        const {container} = render(
            <Button loading={true} type="button">
                Click Me
            </Button>,
        )
        const component = container.firstChild
    ...
    test('render hide text while loading', () => {
        const {container} = render(
            <Button hideTextOnLoading loading={true} type="button">
                Click Me
            </Button>,
        )
        const component = container.firstChild
    ...
    test('render button loading direction:before', () => {
        const {container} = render(
            <Button loadingDirection="before" loading={true} type="button">
                Click Me
            </Button>,
        )
        const component = container.firstChild
    ...
    test('render button loading direction:after', () => {
        const {container} = render(
            <Button loadingDirection="after" loading={true} type="button">
                Click Me
            </Button>,
        )
        const component = container.firstChild
    ...
    test('render button loading style:grow', () => {
        const {container} = render(
            <Button loadingStyle="grow" loading={true} type="button">
                Click Me
            </Button>,
        )
        const component = container.firstChild
