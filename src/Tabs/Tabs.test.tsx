...
describe('Render Tabs Default Themes', () => {
    ...
    themes.forEach(theme => {
        test(`render ${theme} theme`, () => {
            ...
            expect(component).toHaveClass(
                theme === 'default' ? 'tab' : `tab-${theme}`,
            )
            expect(component).not.toHaveClass(
                ...except(themes, theme === 'default' ? 'tab' : `tab-${theme}`),
            )
        })
    })
    test('render custom color scheme', () => {
        ...
        const {container} = render(
            <Tabs data-testid="tab" colorScheme={colorScheme}>
                <TabItem active target="home">
                    Home
                </TabItem>
                <TabItem target="about">About</TabItem>
...
describe('Render Tabs Variants', () => {
    ...
    variants.forEach(variant => {
        test(`render ${variant} variant`, () => {
            ...
            const component = container.firstChild
            expect(component).toHaveClass(
                variant === 'default' ? 'tab' : `tab-${variant}`,
            )
            expect(component).not.toHaveClass(
                ...except(
                    variants,
...
describe('Render Tabs Sizes', () => {
    ...
    sizes.forEach(size => {
        test(`render ${size} size`, () => {
            ...
            const component = container.firstChild
            expect(component).toHaveClass(
                size === 'md' ? 'tab' : `tab-${ISizes[size]}`,
            )
            expect(component).not.toHaveClass(
                ...except(sizes, size === 'md' ? 'tab' : `tab-${ISizes[size]}`),
            )
        })
    })
})
...
describe('Render Floating-Lines Line Direction', () => {
    ...
    lineDirections.forEach(lineDirection => {
        test(`render ${lineDirection} lineDirection`, () => {
            const {container} = render(
                <Tabs variant="floating-line" lineDirection={lineDirection}>
                    <TabItem active target="home">
                        Home
                    </TabItem>
                    <TabItem target="about">About</TabItem>
            ...
            expect(component).toHaveClass(
                lineDirection === 'left'
                    ? 'tab-floating-line'
                    : `tab-floating-line-${lineDirection}`,
            )
            expect(component).not.toHaveClass(
                ...except(
                    lineDirections,
