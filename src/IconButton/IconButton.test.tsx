...
describe('Render IconButton Default Themes', () => {
    ...
    themes.forEach(theme => {
        test(`render ${theme} theme`, () => {
            const {container} = render(
                <IconButton theme={theme}>Click Me</IconButton>,
            )
            const component = container.firstChild
    ...
    test('render custom color scheme', () => {
        ...
        const {container} = render(
            <IconButton colorScheme={colorScheme}>Click Me</IconButton>,
        )
...
describe('Render IconButton Layouts', () => {
    ...
    layouts.forEach(layout => {
        test(`render ${layout} layout`, () => {
            const {container} = render(
                <IconButton layout={layout}>Click Me</IconButton>,
            )
            const component = container.firstChild
            expect(component).toHaveClass(
...
describe('Render IconButton Variants', () => {
    ...
    variants.forEach(variant => {
        test(`render ${variant} variant`, () => {
            const {container} = render(
                <IconButton variant={variant}>Click Me</IconButton>,
            )
            const component = container.firstChild
            expect(component).toHaveClass(
...
describe('Render IconButton Sizes', () => {
    ...
    sizes.forEach(size => {
        test(`render ${size} size`, () => {
            const {container} = render(
                <IconButton size={size}>Click Me</IconButton>,
            )
            const component = container.firstChild
            expect(component).toHaveClass(
                size === 'md' ? 'btn' : `btn-${ISizes[size]}`,
            )
            expect(component).not.toHaveClass(
                ...except(sizes, size === 'md' ? '' : `btn-${ISizes[size]}`),
            )
        })
    })
    test('render fullwidth button', () => {
        const {container} = render(
            <IconButton fullwidth>Click Me</IconButton>,
        )
        const component = container.firstChild
...
describe('Render IconButton With Icons', () => {
    test('render suffix icon', () => {
        const {container} = render(
            <IconButton
                suffix={
                    <i data-testid="icon1" className="bx bxs-user-circle"></i>
                }
                type="button"
            >
                Click Me
    ...
    test('render both icon', () => {
        const {container} = render(
            <IconButton
                ...
                prefix={
                    <i data-testid="icon2" className="bx bxs-user-circle"></i>
                }
                type="button"
            >
                Click Me
...
describe('Render IconButton States', () => {
    test('render disabled button', () => {
        const {container} = render(
            <IconButton disabled={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render not disabled button', () => {
        const {container} = render(
            <IconButton type="button">Click Me</IconButton>,
        )
        const component = container.firstChild
    ...
    test('render loading button', () => {
        const {container} = render(
            <IconButton loading={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render no loading button', () => {
        const {container} = render(
            <IconButton loading={false} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render hide text while loading', () => {
        const {container} = render(
            <IconButton hideTextOnLoading loading={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render button loading direction:before', () => {
        const {container} = render(
            <IconButton loadingDirection="before" loading={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render button loading direction:after', () => {
        const {container} = render(
            <IconButton loadingDirection="after" loading={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
    ...
    test('render button loading style:grow', () => {
        const {container} = render(
            <IconButton loadingStyle="grow" loading={true} type="button">
                Click Me
            </IconButton>,
        )
        const component = container.firstChild
