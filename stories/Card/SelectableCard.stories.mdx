...
export const templateCodeDefaultSelectable = `
import {
  SelectableCard,
  Col,
  Row,
...
export const DefaultSelectable = () => {
  return (
  <Row>
    <Col xs>
      <SelectableCard
        categoryTitle={<><i className="bi bi-box"></i>Laptop</>}
...
export const templateCodeCardTypes = `
import {
  SelectableCard,
  Col,
  Row,
...
export const templateCodeActiveCard = `
import {
  SelectableCard,
  Form,
  Col,
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeDefaultSelectable,
        },
        type: 'code',
      },
    }}
...
```jsx
import { SelectableCard } from 'artific-ui/Card';
```
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: templateCodeActiveCard,
        },
        type: 'code',
      },
    }}
  >
    {ActiveBorderTemplate.bind({})}
  </Story>
</Canvas>
