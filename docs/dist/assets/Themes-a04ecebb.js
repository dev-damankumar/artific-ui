import { j as o, a as c, F as d, T as i } from './index-cab7d04f.js'
function r(n) {
    const e = Object.assign({ h2: 'h2', p: 'p', code: 'code' }, n.components)
    return c(d, {
        children: [
            o('div', {
                className: 'main-blogs',
                children: n.noMainHeading
                    ? o(i, { title: 'Artific UI - Themes' })
                    : o(e.h2, { children: 'Artific UI - Themes' }),
            }),
            `
`,
            o('h2', { children: 'Theme' }),
...
`,
            c(e.p, {
                children: [
                    o(e.code, { children: 'theme' }),
                    ' props has basic four values (',
                    o(e.code, { children: 'primary' }),
                    '|',
                    o(e.code, { children: 'secondary' }),
                    '|',
                    o(e.code, { children: 'dark' }),
                    '|',
                    o(e.code, { children: 'light' }),
                    ').',
                ],
            }),
            `
...
`,
            c(e.p, {
                children: [
                    ...
                    o(e.code, { children: 'background' }),
                    ', ',
                    o(e.code, { children: 'backgroundColor' }),
                    ', ',
                    o(e.code, { children: 'color' }),
                    '.',
                ],
            }),
            `
`,
            c(e.p, {
                children: [
                    ...
                    o(e.code, { children: 'color' }),
                    ' | ',
                    o(e.code, { children: 'gredient' }),
                    ' | ',
                    o(e.code, { children: 'url' }),
