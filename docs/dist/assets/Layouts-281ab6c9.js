import { j as n, a as t, F as s, T as a } from './index-cab7d04f.js'
function i(o) {
        ...
        children: [
            n('div', {
                ...
                children: o.noMainHeading
                    ? n(a, { title: 'Artific UI - Layouts' })
                    : n(e.h2, { children: 'Artific UI - Layouts' }),
            }),
            `
`,
            n(e.p, {
...
`,
            t(e.p, {
                children: [
                    ...
                    '|',
                    n(e.code, { children: 'rounded' }),
                    '|',
                    n(e.code, { children: 'no-radius' }),
                    '|',
                    n(e.code, { children: 'pill' }),
                    ').',
                ],
            }),
            `
