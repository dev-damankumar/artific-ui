import{i as h,a as i,F as a,j as e,x as d}from"./index-cab7d04f.js";const u=t=>{const n=h();return n.config({dismissible:!0}),i(a,{children:[e(d,{onClick:()=>{n.success("Hi ! This is a message").hold()},children:"Success"}),e(d,{onClick:()=>{n.info("Hi ! This is a message").hold()},children:"Info"}),e(d,{onClick:()=>{n.error("Hi ! This is a message").hold()},children:"Danger"}),e(d,{onClick:()=>{n.warning("Hi ! This is a message").hold()},children:"Warning"})]})},p=t=>{const c=["xl","lg","md","sm","xs"].map((o,r)=>{const s=h();return s.config({size:o,dismissible:!0}),i("div",{children:[i(d,{onClick:()=>{s.success("Hi ! This is a message").hold()},children:["Message `",o,"`"]}),e("br",{})]},r)});return e(a,{children:c})},g=t=>{const c=["default","rounded","no-radius","pill"].map((o,r)=>{const s=h();return s.config({layout:o}),i("div",{children:[i(d,{onClick:()=>{s.success("Hi ! This is a message").hold()},children:["Layout `",o,"`"]}),e("br",{})]},r)});return e(a,{children:c})},f=t=>{const c=["primary","secondary","dark","light"].map((r,s)=>{const l=h();return l.config({theme:r,dismissible:!0}),i("div",{children:[i(d,{onClick:()=>{l.alert("Hi ! This is a message").hold()},children:["Theme `",r,"`"]}),e("br",{})]},s)}),o=h();return o.config({colorScheme:{background:"linear-gradient(45deg, #e736f4, #673ab7)",backgroundColor:"#e736f4",color:"white"},dismissible:!0}),i(a,{children:[c,e(d,{onClick:()=>{o.alert("Hi ! This is a message").hold()},children:"Custom Theme"})]})},b=t=>{const c=["default","outline","note"].map((o,r)=>{const s=h();return s.config({variant:o,dismissible:!0}),i("div",{children:[i(d,{onClick:()=>{s.success("Hi ! This is a message").hold()},children:["Variant `",o,"`"]}),e("br",{})]},r)});return e(a,{children:c})},y=t=>{const c=["success","info","error","warning"].map((o,r)=>{const s=h();return s.config({mode:"dark"}),i("div",{children:[i(d,{onClick:()=>{s[o]("Hi ! This is a message")},children:["Dark Mode for `",o,"`"]}),e("br",{})]},r)});return e(a,{children:c})},v=t=>{const c=["success","info","error","warning"].map((o,r)=>{const s=h();return s.config({duration:r+3}),i("div",{children:[i(d,{onClick:()=>{s[o]("Hi ! This is a message")},children:["Duration ",r+3,"s"]}),e("br",{})]},r)});return e(a,{children:c})},k=t=>{const c=["success","info","error","warning","alert"].map((o,r)=>{const s=h();return s.config({type:"notification",dismissible:!0}),i("div",{children:[i(d,{onClick:()=>{s[o]("Hi User! This is a notification message","Message From Artific").hold()},children:["Notification ",o.toUpperCase()]}),e("br",{})]},r)});return e(a,{children:c})},M=t=>{const c=["top","top-right","bottom-left","bottom","bottom-right","top-left"].map((o,r)=>{const s=h();return s.config({dismissible:!0,position:o}),i("div",{children:[i(d,{onClick:()=>{s.success("Hi ! This is a message").hold()},children:["Message ",o]}),e("br",{})]},r)});return e(a,{children:c})};function m(t){const n=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code"},t.components);return i(a,{children:[e(n.h1,{children:"Messages"}),`
...
`,e("div",{children:e("div",{name:"Message Positions",children:M.bind({})})})]})}function w(t={}){const{wrapper:n}=t.components||{};return n?e(n,Object.assign({},t,{children:e(m,t)})):m(t)}export{y as DarkModeTemplate,v as DurationTemplate,g as LayoutsTemplate,k as NotificationTemplate,M as PositionTemplate,p as SizeTemplate,u as Template,f as ThemesTemplate,b as VariantsTemplate,w as default};
