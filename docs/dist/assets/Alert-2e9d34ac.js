    ...
    return r
        ? i(
              ...
              Object.assign({}, n, {
                  ...
                  children: [
                      e('i', {
                          className: 'bi bi-info-circle flex-shrink-0 me-4',
                      }),
                      'This is an Alert',
                  ],
              }),
          )
        : e(l, { onClick: () => d(!0), children: 'Show Alert' })
}
function o(n) {
...
`,
            e('div', {
                children: e('div', { name: 'Default', children: c.bind({}) }),
            }),
            `
`,
            e(r.h2, { children: 'API' }),
...
`,
            e(r.pre, {
                children: e(r.code, {
                    ...
                    children: `import { Alert } from 'artific-ui/Alert';
`,
                }),
            }),
            `
            ...
            e('div', {
                children: e('div', {
                    ...
                    children: i(t, {
                        dismiss: 'true',
                        children: [
                            e('strong', { children: 'Primary!' }),
                            ' You should ',
                            e('a', {
                                href: 'data/Alert.stories#',
                                children: `read this\r
message`,
                            }),
                            '.',
                        ],
...
`,
            e('div', {
                children: i('div', {
                    name: 'Custom Alert',
                    children: [
                        e('h5', { children: 'CustomScheme Alerts' }),
                        e('br', {}),
                        e(t, {
                            dismiss: 'true',
                            colorScheme: {
...
`,
            e('div', {
                children: i('div', {
                    name: 'Alert Layouts',
                    children: [
                        e('h5', { children: 'Alerts Layouts' }),
                        e('br', {}),
                        i(t, {
                            layout: 'rounded',
                            children: [
                                e('strong', { children: 'Rounded!' }),
                                ' You should ',
                                e('a', {
                                    href: 'data/Alert.stories#',
                                    children: `read this\r
...
`,
            i(r.p, {
                children: [
                    'Alert Note Variant has ',
                    e(r.code, { children: 'direction' }),
                    ' prop to define which direction the alert should follow.',
                ],
            }),
            `
`,
            i(r.p, {
                children: [
                    ...
                    e(r.code, { children: 'direction' }),
                    ' prop with the value of (',
                    e(r.code, { children: 'top' }),
                    '|',
                    e(r.code, { children: 'bottom' }),
                    '|',
                    e(r.code, { children: 'left' }),
                    '|',
                    e(r.code, { children: 'right' }),
                    '). you can mix them with different supported ',
                    e(r.code, { children: 'theme' }),
                    ' or ',
                    e(r.code, { children: 'layout' }),
...
function u(n = {}) {
    ...
    return r ? e(r, Object.assign({}, n, { children: e(o, n) })) : o(n)
}
export { c as Template, u as default }
