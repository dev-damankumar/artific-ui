import { j as n, a as c, F as r, T as t } from './index-cab7d04f.js'
function i(o) {
    const e = Object.assign({ h2: 'h2', p: 'p', code: 'code' }, o.components)
    return c(r, {
        children: [
            n('div', {
                className: 'main-blogs',
                children: o.noMainHeading
                    ? n(t, { title: 'Artific UI - Variants' })
                    : n(e.h2, { children: 'Artific UI - Variants' }),
            }),
            `
`,
...
`,
            c(e.p, {
                children: [
                    n(e.code, { children: 'variant' }),
                    ` prop has different the values based on which component you are using\r
but most common are (`,
                    n(e.code, { children: 'default' }),
                    '|',
                    n(e.code, { children: 'outline' }),
                    '|',
                    n(e.code, { children: 'separate' }),
                    '|',
                    n(e.code, { children: 'text' }),
                    '). you can mix them with diffrent supported ',
                    n(e.code, { children: 'theme' }),
                    ' or ',
                    n(e.code, { children: 'layout' }),
