                ...
                <Suspense fallback={<ContentLoader />}>
                    <Routes>
                        <Route
                            path="/"
                            exact
                            element={<GetStarted noMainHeading={true} />}
                        />
                        <Route
                            path="/get-started"
                            element={<GetStarted noMainHeading={true} />}
                        ...
                        <Route
                            path="/installation"
                            element={<Installation noMainHeading={true} />}
                        />
                        <Route
                            path="/layouts"
                            element={<Layouts noMainHeading={true} />}
                        />
                        <Route
                            path="/variants"
                            element={<Variants noMainHeading={true} />}
                        />
                        <Route
                            path="/themes"
                            element={<Themes noMainHeading={true} />}
                        />
                        <Route
                            path="/sizes"
                            element={<Sizes noMainHeading={true} />}
                        />
                        {docs.map((doc, index) => {
                            return (
                                <Route
