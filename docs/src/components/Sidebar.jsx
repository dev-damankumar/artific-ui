		...
		<div className="sidebar">
			...
			<div className="side-wrapper">
				<div className="side-menu">
					<NavLink activeClassName="is-active" className="sidebar-link  is-active" to="/get-started">
					...
					<div className="side-menu nested">
						{docs.map(doc => {
							return <NavLink activeClassName="is-active" className="sidebar-link" to={doc.path}>
								{doc.name}
							</NavLink>
						})}
					</div>
