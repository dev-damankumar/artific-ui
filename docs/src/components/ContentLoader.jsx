	...
	return (
		<Space gap={15}>
			<div className="main-blog anim">
				<div className="main-blog__title loading">Lorem ipsum dolor sit amet.</div>
				<div className="main-blog__author">
					<div className="author-img__wrapper">
						...
						<div className="loading loading-img loading-rounded" style={{width: 42, height: 42}}></div>
					</div>
					<div>
			...
			<p className='loading loading-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, quia.</p>
			<p className='loading loading-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur
				doloribus ea
				iure minima, nobis
				optio! Aspernatur doloremque dolorum fugiat maiores.</p>
			<p className='loading loading-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur
				doloribus ea
				iure minima, nobis
				optio! Aspernatur doloremque dolorum fugiat maiores.</p>
