					...
					<div className="video-stream">
						...
						<div className="video-detail">
							<div className="video-content">
								...
								<div className="video-p-title anim">Basic how to ride your
									Skateboard
								</div>
								<div className="video-p-subtitle anim">Lorem ipsum dolor sit
									amet consectetur adipisicing elit. Repellendus illum tempora consequuntur. Lorem
									ipsum dolor sit amet consectetur adipisicing elit. Debitis earum velit accusantium
									maiores qui sit quas, laborum voluptatibus vero quidem tempore facilis voluptate
									tempora deserunt!
								</div>
								<div className="video-p-subtitle anim">Lorem ipsum dolor sit
									amet consectetur adipisicing elit. Temporibus laborum qui dolorum fugiat eius
									accusantium repellendus illum tempora consequuntur. Lorem ipsum dolor, sit amet
					...
					<div className="chat-stream">
                      ...
                      15,988 people
							...
							<div className="message-container">
								<div className="message anim">
									...
									<div className="msg-wrapper">
										...
										<div className="msg__content video-p-sub"> Lorem ipsum clor sit, ame conse quae
											debitis
										</div>
									</div>
								</div>
								<div className="message anim">
									...
									<div className="msg-wrapper">
										...
										<div className="msg__content video-p-sub"> Suscipit eos atque voluptates
											labore
										</div>
									</div>
								</div>
								...
								<div className="message anim">
									...
									<div className="msg-wrapper">
										...
										<div className="msg__content video-p-sub"> recusandae doloremque aperiam alias
											molestias
										</div>
									</div>
								</div>
						...
						<div className="chat-vid__container">
							...
							<div className="chat-vid anim">
								<div className="chat-vid__wrapper">
									...
									<div className="chat-vid__content">
										...
										<div className="chat-vid__info">125.908 views <span className="seperate"/>2 days
											ago
										</div>
									</div>
								</div>
							...
							<div className="chat-vid__button anim">See All related videos
								(32)
							</div>
						</div>
					</div>
